...
export const PenyewaForm: FC<PenyewaFormProps> = ({
  ...
  // Fields that are disabled in edit mode
  const disabledInEdit = (fieldName: string) => {
    return mode === 'edit' && ['nama', 'tanggal_masuk', 'room_id', 'deposit'].includes(fieldName);
  };
    ...
    <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          disabled={disabledInEdit('nama') || isLoading}
          {...form.register('nama')}
        />
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          disabled={disabledInEdit('room_id') || isLoading}
        >
      ...
      <div className="space-y-2">
        ...
        <Input
          id="tanggal_masuk"
          type="date"
          disabled={disabledInEdit('tanggal_masuk') || isLoading}
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          disabled={disabledInEdit('deposit') || isLoading}
