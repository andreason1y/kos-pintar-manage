...
export default function KeuanganPage() {
  ...
  const fetchData = async () => {
    ...
    const totalPemasukan = txData.reduce((s: number, t: any) => s + (t.jumlah_dibayar || 0), 0);
    const totalPengeluaran = expData.reduce((s: number, e: any) => s + (e.jumlah || 0), 0);
  ...
  useEffect(() => { fetchData(); }, [activeProperty, bulan, tahun]);
